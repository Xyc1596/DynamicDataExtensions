...
public class TranslatableLang extends ModuleLang {
    ...
    public TranslatableLang(
        ...
        Set<com.xyc.practicalextensions.lang.TranslatableLang> allTranslatableChildren = new HashSet<>();
        for (ModuleLang child : children) {
            if (child instanceof com.xyc.practicalextensions.lang.TranslatableLang tc) {
        ...
        for (com.xyc.practicalextensions.lang.TranslatableLang child : allTranslatableChildren) {
    ...
    public static com.xyc.practicalextensions.lang.TranslatableLang of(String category, String namespace, String id) {
        return new com.xyc.practicalextensions.lang.TranslatableLang(
