...
public class TranslatableBuilder extends ModuleLangBuilder<TranslatableBuilder> {
    ...
    public com.xyc.practicalextensions.lang.TranslatableBuilder child(ModuleLang child) {
        this.children.add(child);
        return this;
    }

    public com.xyc.practicalextensions.lang.TranslatableBuilder translation(String locale, String text) {
